...
--
-- Dumping data for table `attack_techniques`
--

LOCK TABLES `attack_techniques` WRITE;
/*!40000 ALTER TABLE `attack_techniques` DISABLE KEYS */;
/*!40000 ALTER TABLE `attack_techniques` ENABLE KEYS */;
UNLOCK TABLES;
